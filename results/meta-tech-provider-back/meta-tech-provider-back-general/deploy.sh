#!/usr/bin/env bash
# deploy.sh — meta-tech-provider-back
#
...
#   bootstrap del proyecto (cdk-mtpdevbck-deploy-role, cdk-mtpdevbck-file-publishing-role).
...
readonly PROJECT_ID="meta-tech-provider-back"
readonly QUALIFIER="mtpdevbck"
readonly TOOLKIT_STACK_NAME="meta-tech-provider-back-cdk-toolkit"
...
echo "========================================"
echo " Deploy : meta-tech-provider-back"
echo " Env    : $ENV"
...
# cdk-mtpdevbck-deploy-role para orquestar el despliegue en CloudFormation.
