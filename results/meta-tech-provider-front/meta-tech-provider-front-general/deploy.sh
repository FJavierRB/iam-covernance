#!/usr/bin/env bash
# deploy.sh — meta-tech-provider-front
#
...
#   bootstrap del proyecto (cdk-mtpdevfrt-deploy-role, cdk-mtpdevfrt-file-publishing-role).
...
readonly PROJECT_ID="meta-tech-provider-front"
readonly QUALIFIER="mtpdevfrt"
readonly TOOLKIT_STACK_NAME="meta-tech-provider-front-cdk-toolkit"
...
echo "========================================"
echo " Deploy : meta-tech-provider-front"
echo " Env    : $ENV"
...
# cdk-mtpdevfrt-deploy-role para orquestar el despliegue en CloudFormation.
