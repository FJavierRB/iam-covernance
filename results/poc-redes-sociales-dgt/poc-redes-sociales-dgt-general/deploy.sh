#!/usr/bin/env bash
# deploy.sh — poc-redes-sociales-dgt
#
...
#   bootstrap del proyecto (cdk-dgtdev-deploy-role, cdk-dgtdev-file-publishing-role).
...
readonly PROJECT_ID="poc-redes-sociales-dgt"
readonly QUALIFIER="dgtdev"
readonly TOOLKIT_STACK_NAME="poc-redes-sociales-dgt-cdk-toolkit"
...
echo "========================================"
echo " Deploy : poc-redes-sociales-dgt"
echo " Env    : $ENV"
...
# cdk-dgtdev-deploy-role para orquestar el despliegue en CloudFormation.
